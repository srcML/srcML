...
SRCML_VERSION_NUMBER = 9005
# string containing libsrcml version
SRCML_VERSION_STRING = "0.9.5"
...
SRCML_OPTION_DEFAULT = (SRCML_OPTION_ARCHIVE | SRCML_OPTION_XML_DECL | SRCML_OPTION_NAMESPACE_DECL | SRCML_OPTION_HASH | SRCML_OPTION_PSEUDO_BLOCK | SRCML_OPTION_TERNARY)
