...
token_set(srcMLParser, skip_tokens_set,
    ...
    srcMLParser::HASHTAG_COMMENT_START, srcMLParser::HASHTAG_COMMENT_END, srcMLParser::HASHBANG_COMMENT_START, srcMLParser::HASHBANG_COMMENT_END, srcMLParser::XML_COMMENT_START, srcMLParser::XML_COMMENT_END,
    srcMLParser::WS_EOL
)
...
token_set(srcMLParser, whitespace_token_set,
    ...
    srcMLParser::XML_COMMENT_START,
    srcMLParser::XML_COMMENT_END
)
