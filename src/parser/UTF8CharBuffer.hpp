...
public:
    ...
    UTF8CharBuffer(const char * ifilename, const char * encoding, srcml_read_callback read_callback, srcml_close_callback close_callback, void * context, boost::optional<std::string> * hash);
