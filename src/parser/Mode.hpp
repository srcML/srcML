...
const static srcMLState::MODE_TYPE MODE_FUNCTION_RS;

const static srcMLState::MODE_TYPE MODE_FUNCTION_DECLARATION_RS;

const static srcMLState::MODE_TYPE MODE_FUNCTION_DEFINITION_RS;
