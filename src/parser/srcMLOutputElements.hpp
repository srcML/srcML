...
const std::unordered_map<int, Element> srcMLOutput::process = {
    ...
    { TOKEN::SCOMPREHENSION,                { "comprehension",     SRC,      0,           0,        0,                   0 }},
    { TOKEN::SDELETE,                       { "delete",            SRC,      0,           0,        0,                   0 }},
    { TOKEN::SDICTIONARY,                   { "dictionary",        SRC,      0,           0,        0,                   0 }},
    { TOKEN::SDOCSTRING_PY,                 { "literal",           SRC, "type",    "string", "format",         "docstring" }},
    { TOKEN::SDOCSTRING_DOXYGEN_PY,         { "literal",           SRC, "type",    "string", "format", "docstring doxygen" }},
    ...
    { TOKEN::SPRINT_PYTHON2,                { "print",             SRC,      0,           0,        0,                   0 }},
    ...
    { TOKEN::SCALIBRATION_STATEMENT,        { "calibration",       SRC,      0,           0,        0,                   0 }},
    ...
    { TOKEN::SGATE_STATEMENT,               { "gate",              SRC,      0,           0,        0,                   0 }},
    { TOKEN::SGATE_DEFCAL_STATEMENT,        { "gate",              SRC,  "type",   "defcal",        0,                   0 }},
    { TOKEN::SINCLUDE_STATEMENT,            { "include",           SRC,      0,           0,        0,                   0 }},
    { TOKEN::SMEASURE_STATEMENT,            { "measure",           SRC,      0,           0,        0,                   0 }},
    //{ TOKEN::SMEASURE_DEFCAL_STATEMENT,     { "measure",           SRC,  "type",   "defcal",        0,                   0 }},
    { TOKEN::SNOP_STATEMENT,                { "nop",               SRC,      0,           0,        0,                   0 }},
