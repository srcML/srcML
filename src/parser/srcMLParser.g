...
/*
  ...
  Handles a CMake option.  The full list of options is in cmake_option_list.
*/
...
/*
  ...
  Contains the list of valid CMake options.
*/
cmake_option_list[] { ENTRY_DEBUG } :
        ABSOLUTE_CMAKE | ABSOLUTE_PATH_CMAKE | ACTION_CMAKE | AFTER_CMAKE | AFTER_TIMEOUT_CMAKE | ALIAS_CMAKE |
        ALIAS_GLOBAL_CMAKE | ALL_CMAKE | ALLOW_SYSTEM_INCLUDES_CMAKE | ALLOW_SYSTEM_LIBS_CMAKE | ALL_BUILD_CMAKE |
        ALL_COMPONENTS_CMAKE | ALPHABET_CMAKE | ANDROID_MK_CMAKE | ANGLE_CMAKE | ANSI_CMAKE | ANY_CMAKE |
        API_VERSION_CMAKE | APPEND_CMAKE | APPENDIX_CMAKE | APPEND_STRING_CMAKE | ARCHIVE_CMAKE | ARCHIVE_CREATE_CMAKE |
        ARCHIVE_EXTRACT_CMAKE | ARCHIVE_OUTPUT_DIRECTORY_CMAKE | ARGC_CMAKE | ARGN_CMAKE | ARGS_CMAKE | ARGV_CMAKE |
        ARRAY_CMAKE | ASCENDING_CMAKE | ASCII_CMAKE | ASM_MARMASM_CMAKE | ASM_MASM_CMAKE | ASM_NASM_CMAKE | AT_CMAKE |
        ATTACHED_FILES_CMAKE | ATTACHED_FILES_ON_FAIL_CMAKE | AUTHOR_WARNING_CMAKE | AUTO_CMAKE | AUTOMOC_CMAKE |
        AUTOUIC_CMAKE | AVAILABLE_PHYSICAL_MEMORY_CMAKE | AVAILABLE_VIRTUAL_MEMORY_CMAKE |

        BASE_DIR_CMAKE | BASE_DIRECTORY_CMAKE | BASE_DIRS_CMAKE | BEFORE_CMAKE | BEST_EFFORT_CMAKE | BIN_CMAKE |
        BINARY_DIR_CMAKE | BOOL_CMAKE | BOOLEAN_CMAKE | BOTH_CMAKE | BRIEF_DOCS_CMAKE | BUILD_CMAKE | BUILD_DIR_CMAKE |
        BUILD_ID_CMAKE | BUILD_INTERFACE_CMAKE | BUILD_SHARED_LIBS_CMAKE | BUILD_TESTING_CMAKE | BUILD_TYPE_CMAKE |
        BUNDLE_CMAKE | BUNDLE_EXECUTABLE_CMAKE | BYPASS_PROVIDER_CMAKE | BYPRODUCTS_CMAKE |

        CACHE_CMAKE | CACHED_VARIABLE_CMAKE | CALL_CMAKE | CANCEL_CALL_CMAKE | CAPTURE_CMAKE_ERROR_CMAKE | CASE_CMAKE |
        CATEGORY_CMAKE | CDASH_UPLOAD_CMAKE | CDASH_UPLOAD_TYPE_CMAKE | CFLAGS_CMAKE | CHECK_FAIL_CMAKE |
        CHECK_PASS_CMAKE | CHECK_START_CMAKE | CHMOD_CMAKE | CHMOD_RECURSE_CMAKE | CLEAR_CMAKE | CMAKEFILES_CMAKE |
        CMAKE_ADD_CUSTOM_COMMAND_DEPENDS_EXPLICIT_ONLY_CMAKE | CMAKE_APPBUNDLE_PATH_CMAKE | CMAKE_BINARY_DIR_CMAKE |
        CMAKE_BUILD_PARALLEL_LEVEL_CMAKE | CMAKE_BUILD_TYPE_CMAKE | CMAKE_COMMAND_CMAKE | CMAKE_CROSSCOMPILING_CMAKE |
        CMAKE_CROSSCOMPILING_EMULATOR_CMAKE | CMAKE_CUDA_COMPILE_FEATURES_CMAKE | CMAKE_CUDA_EXTENSIONS_CMAKE |
        CMAKE_CUDA_RUNTIME_LIBRARY_CMAKE | CMAKE_CUDA_STANDARD_CMAKE | CMAKE_CUDA_STANDARD_REQUIRED_CMAKE |
        CMAKE_CURRENT_BINARY_DIR_CMAKE | CMAKE_CURRENT_FUNCTION_CMAKE | CMAKE_CURRENT_FUNCTION_LIST_DIR_CMAKE |
        CMAKE_CURRENT_FUNCTION_LIST_FILE_CMAKE | CMAKE_CURRENT_FUNCTION_LIST_LINE_CMAKE | CMAKE_CURRENT_LIST_FILE_CMAKE |
        CMAKE_CURRENT_SOURCE_DIR_CMAKE | CMAKE_CXX_COMPILER_CMAKE | CMAKE_CXX_COMPILE_FEATURES_CMAKE |
        CMAKE_CXX_EXTENSIONS_CMAKE | CMAKE_CXX_STANDARD_CMAKE | CMAKE_CXX_STANDARD_REQUIRED_CMAKE |
        CMAKE_C_COMPILE_FEATURES_CMAKE | CMAKE_C_EXTENSIONS_CMAKE | CMAKE_C_STANDARD_CMAKE |
        CMAKE_C_STANDARD_REQUIRED_CMAKE | CMAKE_ENABLE_EXPORTS_CMAKE | CMAKE_ERROR_DEPRECATED_CMAKE |
        CMAKE_EXECUTE_PROCESS_COMMAND_ECHO_CMAKE | CMAKE_EXE_LINKER_FLAGS_CMAKE |
        CMAKE_EXPERIMENTAL_EXPORT_PACKAGE_DEPENDENCIES_CMAKE | CMAKE_EXPERIMENTAL_EXPORT_PACKAGE_INFO_CMAKE |
        CMAKE_EXPORT_NO_PACKAGE_REGISTRY_CMAKE | CMAKE_EXPORT_PACKAGE_REGISTRY_CMAKE |
        CMAKE_FIND_APPBUNDLE_CMAKE | CMAKE_FIND_FRAMEWORK_CMAKE | CMAKE_FIND_LIBRARY_CUSTOM_LIB_SUFFIX_CMAKE |
        CMAKE_FIND_PACKAGE_NAME_CMAKE | CMAKE_FIND_PACKAGE_NO_PACKAGE_REGISTRY_CMAKE |
        CMAKE_FIND_PACKAGE_NO_SYSTEM_PACKAGE_REGISTRY_CMAKE | CMAKE_FIND_PACKAGE_PREFER_CONFIG_CMAKE |
        CMAKE_FIND_PACKAGE_REDIRECTS_DIR_CMAKE | CMAKE_FIND_PACKAGE_RESOLVE_SYMLINKS_CMAKE |
        CMAKE_FIND_PACKAGE_SORT_DIRECTION_CMAKE | CMAKE_FIND_PACKAGE_SORT_ORDER_CMAKE |
        CMAKE_FIND_PACKAGE_TARGETS_GLOBAL_CMAKE | CMAKE_FIND_ROOT_PATH_CMAKE | CMAKE_FIND_ROOT_PATH_BOTH_CMAKE |
        CMAKE_FIND_ROOT_PATH_MODE_INCLUDE_CMAKE | CMAKE_FIND_ROOT_PATH_MODE_LIBRARY_CMAKE |
        CMAKE_FIND_ROOT_PATH_MODE_PACKAGE_CMAKE | CMAKE_FIND_ROOT_PATH_MODE_PROGRAM_CMAKE |
        CMAKE_FIND_USE_CMAKE_ENVIRONMENT_PATH_CMAKE | CMAKE_FIND_USE_CMAKE_PATH_CMAKE |
        CMAKE_FIND_USE_CMAKE_SYSTEM_PATH_CMAKE | CMAKE_FIND_USE_INSTALL_PREFIX_CMAKE |
        CMAKE_FIND_USE_PACKAGE_REGISTRY_CMAKE | CMAKE_FIND_USE_PACKAGE_ROOT_PATH_CMAKE |
        CMAKE_FIND_USE_SYSTEM_ENVIRONMENT_PATH_CMAKE | CMAKE_FIND_USE_SYSTEM_PACKAGE_REGISTRY_CMAKE |
        CMAKE_FLAGS_CMAKE | CMAKE_FRAMEWORK_PATH_CMAKE | CMAKE_GET_OS_RELEASE_FALLBACK_CONTENT_CMAKE |
        CMAKE_GET_OS_RELEASE_FALLBACK_RESULT_CMAKE | CMAKE_GET_OS_RELEASE_FALLBACK_RESULT_ID_CMAKE |
        CMAKE_GET_OS_RELEASE_FALLBACK_RESULT_NAME_CMAKE | CMAKE_GET_OS_RELEASE_FALLBACK_RESULT_PRETTY_NAME_CMAKE |
        CMAKE_GET_OS_RELEASE_FALLBACK_RESULT_VERSION_CMAKE | CMAKE_GET_OS_RELEASE_FALLBACK_RESULT_VERSION_ID_CMAKE |
        CMAKE_GET_OS_RELEASE_FALLBACK_SCRIPTS_CMAKE | CMAKE_GET_RUNTIME_DEPENDENCIES_COMMAND_CMAKE |
        CMAKE_GET_RUNTIME_DEPENDENCIES_PLATFORM_CMAKE | CMAKE_GET_RUNTIME_DEPENDENCIES_TOOL_CMAKE |
        CMAKE_HOST_SYSTEM_NAME_CMAKE | CMAKE_HOST_SYSTEM_PROCESSOR_CMAKE | CMAKE_IGNORE_PATH_CMAKE |
        CMAKE_IGNORE_PREFIX_PATH_CMAKE | CMAKE_INCLUDE_DIRECTORIES_BEFORE_CMAKE | CMAKE_INCLUDE_PATH_CMAKE |
        CMAKE_INSTALL_BINDIR_CMAKE | CMAKE_INSTALL_DATADIR_CMAKE | CMAKE_INSTALL_DATAROOTDIR_CMAKE |
        CMAKE_INSTALL_DEFAULT_COMPONENT_NAME_CMAKE | CMAKE_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS_CMAKE |
        CMAKE_INSTALL_DOCDIR_CMAKE | CMAKE_INSTALL_INCLUDEDIR_CMAKE | CMAKE_INSTALL_INFODIR_CMAKE |
        CMAKE_INSTALL_LIBDIR_CMAKE | CMAKE_INSTALL_LIBEXECDIR_CMAKE | CMAKE_INSTALL_LOCALEDIR_CMAKE |
        CMAKE_INSTALL_LOCALSTATEDIR_CMAKE | CMAKE_INSTALL_MANDIR_CMAKE | CMAKE_INSTALL_MESSAGE_CMAKE |
        CMAKE_INSTALL_MODE_CMAKE | CMAKE_INSTALL_PREFIX_CMAKE | CMAKE_INSTALL_RUNSTATEDIR_CMAKE |
        CMAKE_INSTALL_SBINDIR_CMAKE | CMAKE_INSTALL_SHARESTATEDIR_CMAKE | CMAKE_INSTALL_SYSCONFDIR_CMAKE |
        CMAKE_LIBRARY_ARCHITECTURE_CMAKE | CMAKE_LIBRARY_PATH_CMAKE | CMAKE_LINK_DIRECTORIES_BEFORE_CMAKE |
        CMAKE_LINK_LIBRARIES_STRATEGY_CMAKE | CMAKE_LINK_SEARCH_END_STATIC_CMAKE | CMAKE_LINK_SEARCH_START_STATIC_CMAKE |
        CMAKE_MESSAGE_CONTEXT_CMAKE | CMAKE_MESSAGE_CONTEXT_SHOW_CMAKE | CMAKE_MESSAGE_INDENT_CMAKE |
        CMAKE_MESSAGE_LOG_LEVEL_CMAKE | CMAKE_MINIMUM_REQUIRED_VERSION_CMAKE | CMAKE_MODULE_PATH_CMAKE |
        CMAKE_MSVC_DEBUG_INFORMATION_FORMAT_CMAKE | CMAKE_MSVC_RUNTIME_LIBRARY_CMAKE | CMAKE_NETRC_CMAKE |
        CMAKE_NETRC_FILE_CMAKE | CMAKE_OBJCXX_EXTENSIONS_CMAKE | CMAKE_OBJCXX_STANDARD_CMAKE |
        CMAKE_OBJCXX_STANDARD_REQUIRED_CMAKE | CMAKE_OBJC_EXTENSIONS_CMAKE | CMAKE_OBJC_STANDARD_CMAKE |
        CMAKE_OBJC_STANDARD_REQUIRED_CMAKE | CMAKE_OBJDUMP_CMAKE | CMAKE_OSX_ARCHITECTURES_CMAKE |
        CMAKE_PKG_CONFIG_ALLOW_SYS_INCLUDES_CMAKE | CMAKE_PKG_CONFIG_ALLOW_SYS_LIBS_CMAKE |
        CMAKE_PKG_CONFIG_CFLAGS_CMAKE | CMAKE_PKG_CONFIG_COMPILE_OPTIONS_CMAKE | CMAKE_PKG_CONFIG_CONFLICTS_CMAKE |
        CMAKE_PKG_CONFIG_DESCRIPTION_CMAKE | CMAKE_PKG_CONFIG_DISABLE_UNINSTALLED_CMAKE |
        CMAKE_PKG_CONFIG_INCLUDES_CMAKE | CMAKE_PKG_CONFIG_LIBDIRS_CMAKE | CMAKE_PKG_CONFIG_LIBNAMES_CMAKE |
        CMAKE_PKG_CONFIG_LIBS_CMAKE | CMAKE_PKG_CONFIG_LINK_OPTIONS_CMAKE | CMAKE_PKG_CONFIG_NAME_CMAKE |
        CMAKE_PKG_CONFIG_PC_LIB_DIRS_CMAKE | CMAKE_PKG_CONFIG_PC_PATH_CMAKE | CMAKE_PKG_CONFIG_PKGCONF_INCLUDES_CMAKE |
        CMAKE_PKG_CONFIG_PKGCONF_LIB_DIRS_CMAKE | CMAKE_PKG_CONFIG_PROVIDES_CMAKE | CMAKE_PKG_CONFIG_REQUIRES_CMAKE |
        CMAKE_PKG_CONFIG_SYSROOT_DIR_CMAKE | CMAKE_PKG_CONFIG_SYS_INCLUDE_DIRS_CMAKE |
        CMAKE_PKG_CONFIG_SYS_LIB_DIRS_CMAKE | CMAKE_PKG_CONFIG_TOP_BUILD_DIR_CMAKE | CMAKE_PKG_CONFIG_VERSION_CMAKE |
        CMAKE_POLICY_DEFAULT_CMP_CMAKE | CMAKE_POSITION_INDEPENDENT_CODE_CMAKE | CMAKE_PREFIX_PATH_CMAKE |
        CMAKE_PROGRAM_PATH_CMAKE | CMAKE_PROJECT_DESCRIPTION_CMAKE | CMAKE_PROJECT_HOMEPAGE_URL_CMAKE |
        CMAKE_PROJECT_INCLUDE_CMAKE | CMAKE_PROJECT_INCLUDE_BEFORE_CMAKE | CMAKE_PROJECT_NAME_CMAKE |
        CMAKE_PROJECT_TOP_LEVEL_INCLUDES_CMAKE | CMAKE_PROJECT_VERSION_CMAKE | CMAKE_SIZEOF_VOID_P_CMAKE |
        CMAKE_STAGING_PREFIX_CMAKE | CMAKE_SYSROOT_CMAKE | CMAKE_SYSTEM_CMAKE | CMAKE_SYSTEM_APPBUNDLE_PATH_CMAKE |
        CMAKE_SYSTEM_FRAMEWORK_PATH_CMAKE | CMAKE_SYSTEM_IGNORE_PATH_CMAKE | CMAKE_SYSTEM_IGNORE_PREFIX_PATH_CMAKE |
        CMAKE_SYSTEM_INCLUDE_PATH_CMAKE | CMAKE_SYSTEM_LIBRARY_PATH_CMAKE | CMAKE_SYSTEM_PREFIX_PATH_CMAKE |
        CMAKE_SYSTEM_PROGRAM_PATH_CMAKE | CMAKE_TESTDRIVER_AFTER_TESTMAIN_CMAKE | CMAKE_TESTDRIVER_BEFORE_TESTMAIN_CMAKE |
        CMAKE_TLS_CAINFO_CMAKE | CMAKE_TLS_VERIFY_CMAKE | CMAKE_TLS_VERSION_CMAKE | CMAKE_TOOLCHAIN_FILE_CMAKE |
        CMAKE_TRY_COMPILE_CONFIGURATION_CMAKE | CMAKE_TRY_COMPILE_NO_PLATFORM_VARIABLES_CMAKE |
        CMAKE_TRY_COMPILE_PLATFORM_VARIABLES_CMAKE | CMAKE_TRY_COMPILE_TARGET_TYPE_CMAKE | CMAKE_WARN_DEPRECATED_CMAKE |
        CMAKE_WATCOM_RUNTIME_LIBRARY_CMAKE | CODE_CMAKE | CODEGEN_CMAKE | CODEMODEL_CMAKE | COMMAND_ECHO_CMAKE |
        COMMAND_ERROR_IS_FATAL_CMAKE | COMMAND_EXPAND_LISTS_CMAKE | COMMAND_NAME_CMAKE | COMMENT_CMAKE | COMPARE_CMAKE |
        COMPAT_VERSION_CMAKE | COMPILE_DEFINITIONS_CMAKE | COMPILE_FEATURES_CMAKE | COMPILE_LANGUAGE_CMAKE |
        COMPILE_OPTIONS_CMAKE | COMPILE_OUTPUT_VARIABLE_CMAKE | COMPONENT_CMAKE | COMPONENTS_CMAKE | COMPRESSION_CMAKE |
        COMPRESSION_LEVEL_CMAKE | CONCAT_CMAKE | CONDITION_CMAKE | CONFIG_CMAKE | CONFIGS_CMAKE | CONFIGURATION_CMAKE |
        CONFIGURATIONS_CMAKE | CONFIGURE_CMAKE | CONFIGURE_DEPENDS_CMAKE | CONFIGURE_FILE_CMAKE | CONFIGURE_LOG_CMAKE |
        CONFLICTING_DEPENDENCIES_PREFIX_CMAKE | CONTENT_CMAKE | CONVERT_CMAKE | COPY_CMAKE | COPYONLY_CMAKE |
        COPY_FILE_CMAKE | COPY_FILE_ERROR_CMAKE | COPY_ON_ERROR_CMAKE | CORRECT_CMAKE | CPATH_CMAKE |
        CPLUS_INCLUDE_PATH_CMAKE | CREATE_LINK_CMAKE | CRLF_CMAKE | CROSSCOMPILING_EMULATOR_CMAKE |
        CTEST_BINARY_DIRECTORY_CMAKE | CTEST_BUILD_COMMAND_CMAKE | CTEST_BUILD_CONFIGURATION_CMAKE |
        CTEST_BUILD_FLAGS_CMAKE | CTEST_BUILD_TARGET_CMAKE | CTEST_CHECKOUT_COMMAND_CMAKE |
        CTEST_CUSTOM_MAXIMUM_FAILED_TEST_OUTPUT_SIZE_CMAKE | CTEST_CUSTOM_MAXIMUM_PASSED_TEST_OUTPUT_SIZE_CMAKE |
        CTEST_CUSTOM_TEST_OUTPUT_TRUNCATION_CMAKE | CTEST_CVS_CHECKOUT_CMAKE | CTEST_EXTRA_SUBMIT_FILES_CMAKE |
        CTEST_NOTES_FILES_CMAKE | CTEST_SOURCE_DIRECTORY_CMAKE | CTEST_SUBMIT_URL_CMAKE | CTEST_TEST_LOAD_CMAKE |
        CUDA_CMAKE | CUDA_EXTENSIONS_CMAKE | CUDA_RESOLVE_DEVICE_SYMBOLS_CMAKE | CUDA_SEPARABLE_COMPILATION_CMAKE |
        CUDA_STANDARD_CMAKE | CUDA_STANDARD_REQUIRED_CMAKE | CXX_EXTENSIONS_CMAKE | CXX_MODULE_CMAKE | CXX_MODULES_CMAKE |
        CXX_MODULES_BMI_CMAKE | CXX_MODULES_DIRECTORY_CMAKE | CXX_MODULE_DIRS_CMAKE | CXX_MODULE_SET_CMAKE |
        CXX_MODULE_SETS_CMAKE | CXX_STANDARD_CMAKE | CXX_STANDARD_REQUIRED_CMAKE | CYGWIN_CMAKE | C_EXTENSIONS_CMAKE |
        C_INCLUDE_PATH_CMAKE | C_STANDARD_CMAKE |C_STANDARD_REQUIRED_CMAKE |

        DATA_CMAKE | DATAROOT_CMAKE | DBAR_CMAKE | DBUILD_TYPE_CMAKE | DCMAKE_PROJECT_TOP_LEVEL_INCLUDES_CMAKE |
        DCOMPILE_DEFINITIONS_CMAKE | DCOMPONENT_CMAKE | DEBUG_CMAKE | DEBUG_CONFIGURATIONS_CMAKE | DEC_CMAKE |
        DECIMAL_CMAKE | DEFAULT_CONFIGURATIONS_CMAKE | DEFAULT_TARGETS_CMAKE | DEFECT_COUNT_CMAKE | DEFER_CMAKE |
        DEFINITION_CMAKE | DEPENDS_CMAKE | DEPENDS_EXPLICIT_ONLY_CMAKE | DEPFILE_CMAKE | DEPRECATION_CMAKE |
        DESCENDING_CMAKE | DESCRIPTION_CMAKE | DESTDIR_CMAKE | DESTINATION_CMAKE | DEVICE_LINK_CMAKE | DFOO_CMAKE |
        DIRECTORIES_CMAKE | DIRECTORY_CMAKE | DIRECTORY_PERMISSIONS_CMAKE | DISABLE_PRECOMPILE_HEADERS_CMAKE |
        DISABLE_UNINSTALLED_CMAKE | DISTRIB_INFO_CMAKE | DISTRIB_PRETTY_NAME_CMAKE | DISTRO_CMAKE |
        DISTRO_BUG_REPORT_URL_CMAKE | DISTRO_HOME_URL_CMAKE | DISTRO_ID_CMAKE | DISTRO_ID_LIKE_CMAKE | DISTRO_NAME_CMAKE |
        DISTRO_PRETTY_NAME_CMAKE | DISTRO_PRIVACY_POLICY_URL_CMAKE | DISTRO_SUPPORT_URL_CMAKE |
        DISTRO_UBUNTU_CODENAME_CMAKE | DISTRO_VERSION_CMAKE | DISTRO_VERSION_CODENAME_CMAKE | DISTRO_VERSION_ID_CMAKE |
        DLINK_LIBRARIES_CMAKE | DOBJ_CMAKE | DOC_CMAKE | DOWNLOAD_CMAKE | DVAR_CMAKE |

        ECHO_ERROR_VARIABLE_CMAKE | ECHO_OUTPUT_VARIABLE_CMAKE | ENABLED_CMAKE | ENABLE_EXPORTS_CMAKE | ENCODING_CMAKE |
        ENV_CMAKE | ENV_MODE_CMAKE | ERROR_FILE_CMAKE | ERROR_QUIET_CMAKE | ERROR_STRIP_TRAILING_WHITESPACE_CMAKE |
        ERROR_VARIABLE_CMAKE | ESCAPE_QUOTES_CMAKE | EVAL_CMAKE | EXACT_CMAKE | EXCLUDE_CMAKE | EXCLUDE_FIXTURE_CMAKE |
        EXCLUDE_FIXTURE_CLEANUP_CMAKE | EXCLUDE_FIXTURE_SETUP_CMAKE | EXCLUDE_FROM_ALL_CMAKE | EXCLUDE_FROM_FILE_CMAKE |
        EXCLUDE_LABEL_CMAKE | EXECUTABLE_CMAKE | EXECUTABLES_CMAKE | EXIT_CMAKE | EXPAND_TILDE_CMAKE |
        EXPECTED_HASH_CMAKE | EXPORT_CMAKE | EXPORT_ANDROID_MK_CMAKE | EXPORT_FIND_PACKAGE_NAME_CMAKE |
        EXPORT_LINK_INTERFACE_LIBRARIES_CMAKE | EXPORT_NAME_CMAKE | EXPORT_PACKAGE_DEPENDENCIES_CMAKE | EXPR_CMAKE |
        EXT_CMAKE | EXTENSION_CMAKE | EXTENSION_DEF_CMAKE | EXTRACT_CMAKE | EXTRA_ARGS_CMAKE | EXTRA_INCLUDE_CMAKE |

        FAILED_TO_RUN_CMAKE | FAIL_REGULAR_EXPRESSION_CMAKE | FAST_CMAKE | FATAL_ERROR_CMAKE | FDO_CMAKE |
        FETCHCONTENT_MAKEAVAILABLE_SERIAL_CMAKE | FETCHCONTENT_TRY_FIND_PACKAGE_MODE_CMAKE | FI_CMAKE | FILE_CMAKE |
        FILENAME_CMAKE | FILENAME_DEF_CMAKE | FILEPATH_CMAKE | FILES_CMAKE | FILES_MATCHING_CMAKE | FILE_BASENAME_CMAKE |
        FILE_PERMISSIONS_CMAKE | FILE_SET_CMAKE | FILTER_CMAKE | FIND_CMAKE | FIND_PACKAGE_CMAKE |
        FIND_PACKAGE_ARGS_CMAKE | FIND_PACKAGE_VERSION_FORMAT_CMAKE | FIND_XXX_CMAKE | FIND_XXX_REGISTRY_VIEW_CMAKE |
        FLAGS_CMAKE | FLTK_CMAKE | FOLLOW_SYMLINKS_CMAKE | FOLLOW_SYMLINK_CHAIN_CMAKE | FOO_ENABLE_CMAKE |
        FOO_STRING_CMAKE | FOR_CMAKE | FORCE_CMAKE | FORMAT_CMAKE | FQDN_CMAKE | FRAMEWORK_CMAKE | FULL_DOCS_CMAKE |
        FUNCTION_CMAKE |

        GENERATE_CMAKE | GENERATED_CMAKE | GENEX_STRIP_CMAKE | GET_CMAKE | GET_CALL_CMAKE | GET_CALL_IDS_CMAKE |
        GET_EXTENSION_CMAKE | GET_FILENAME_CMAKE | GET_MESSAGE_LOG_LEVEL_CMAKE | GET_PARENT_PATH_CMAKE |
        GET_RELATIVE_PART_CMAKE | GET_ROOT_DIRECTORY_CMAKE | GET_ROOT_NAME_CMAKE | GET_ROOT_PATH_CMAKE |
        GET_RUNTIME_DEPENDENCIES_CMAKE | GET_STEM_CMAKE | GIT_REPOSITORY_CMAKE | GIT_SUBMODULES_CMAKE | GIT_TAG_CMAKE |
        GLOB_CMAKE | GLOBAL_CMAKE | GLOB_RECURSE_CMAKE | GROUP_CMAKE | GROUP_EXECUTE_CMAKE | GROUP_READ_CMAKE |
        GROUP_WRITE_CMAKE | GUARD_CMAKE | GUID_CMAKE |

        HASH_CMAKE | HAS_EXTENSION_CMAKE | HAS_FILENAME_CMAKE | HAS_FPU_CMAKE | HAS_MMX_CMAKE | HAS_MMX_PLUS_CMAKE |
        HAS_PARENT_PATH_CMAKE | HAS_RELATIVE_PART_CMAKE | HAS_ROOT_DIRECTORY_CMAKE | HAS_ROOT_NAME_CMAKE |
        HAS_ROOT_PATH_CMAKE | HAS_SERIAL_NUMBER_CMAKE | HAS_SSE_CMAKE | HAS_SSE_FP_CMAKE | HAS_SSE_MMX_CMAKE |
        HAS_STEM_CMAKE | HEADERS_CMAKE | HEADER_DIRS_CMAKE | HEADER_FILE_ONLY_CMAKE | HEADER_SET_CMAKE |
        HEADER_SETS_CMAKE | HEX_CMAKE | HEXADECIMAL_CMAKE | HINTS_CMAKE | HKCC_CMAKE | HKCR_CMAKE | HKCU_CMAKE |
        HKEY_CLASSES_ROOT_CMAKE | HKEY_CURRENT_CONFIG_CMAKE | HKEY_CURRENT_USER_CMAKE | HKEY_LOCAL_MACHINE_CMAKE |
        HKEY_USERS_CMAKE | HKLM_CMAKE | HKU_CMAKE | HOME_CMAKE | HOMEPAGE_URL_CMAKE | HOST_CMAKE | HOSTNAME_CMAKE |
        HOST_LINK_CMAKE | HTTP_CMAKE | HTTPHEADER_CMAKE |

        ID_CMAKE | ID_VAR_CMAKE | IGNORED_CMAKE | IMPLICIT_DEPENDS_CMAKE | IMPORTED_CMAKE | IMPORTED_IMPLIB_CMAKE |
        IMPORTED_LOCATION_CMAKE | IMPORTED_NO_SONAME_CMAKE | IMPORTED_OBJECTS_CMAKE | IMPORTED_RUNTIME_ARTIFACTS_CMAKE |
        IMPORTED_SONAME_CMAKE | INACTIVITY_TIMEOUT_CMAKE | INCLUDE_CMAKE | INCLUDES_CMAKE | INCLUDE_DIRECTORIES_CMAKE |
        INCLUDE_FROM_FILE_CMAKE | INCLUDE_INTERNALS_CMAKE | INCLUDE_LABEL_CMAKE | INFO_CMAKE | INHERITED_CMAKE |
        INITIALIZE_FROM_VARIABLE_CMAKE | INPUT_CMAKE | INPUT_FILE_CMAKE | INPUT_MAY_BE_RECENT_CMAKE | INSENSITIVE_CMAKE |
        INSERT_CMAKE | INSTALL_CMAKE | INSTALL_INTERFACE_CMAKE | INSTALL_PARALLEL_CMAKE | INSTALL_PREFIX_CMAKE |
        INTERFACE_CMAKE | INTERFACE_COMPILE_DEFINITIONS_CMAKE | INTERFACE_COMPILE_FEATURES_CMAKE |
        INTERFACE_COMPILE_OPTIONS_CMAKE | INTERFACE_CXX_MODULE_SETS_CMAKE | INTERFACE_HEADER_SETS_CMAKE |
        INTERFACE_INCLUDE_DIRECTORIES_CMAKE | INTERFACE_LINK_DIRECTORIES_CMAKE | INTERFACE_LINK_LIBRARIES_CMAKE |
        INTERFACE_LINK_OPTIONS_CMAKE | INTERFACE_PRECOMPILE_HEADERS_CMAKE | INTERFACE_SOURCES_CMAKE |
        INTERFACE_SYSTEM_INCLUDE_DIRECTORIES_CMAKE | INTERNAL_CMAKE | ISPC_CMAKE | IS_PREFIX_CMAKE |IS_RELATIVE_CMAKE |
        ITEMS_CMAKE |

        JOB_POOL_CMAKE | JOB_POOLS_CMAKE | JOB_SERVER_AWARE_CMAKE | JOIN_CMAKE | JSON_CMAKE |

        LABELS_CMAKE | LANG_CMAKE | LANGUAGES_CMAKE | LAST_CMAKE | LAST_EXT_CMAKE | LAST_ONLY_CMAKE | LC_ID_DYLIB_CMAKE |
        LENGTH_CMAKE | LENGTH_MAXIMUM_CMAKE | LENGTH_MINIMUM_CMAKE | LIB_CMAKE | LIBEXEC_CMAKE | LIBRARIES_CMAKE |
        LIBRARY_CMAKE | LIBRARY_OUTPUT_DIRECTORY_CMAKE | LIBRARY_PATH_CMAKE | LIBS_CMAKE | LIMIT_CMAKE |
        LIMIT_COUNT_CMAKE | LIMIT_INPUT_CMAKE | LIMIT_OUTPUT_CMAKE | LINKER_CMAKE | LINKER_LANGUAGE_CMAKE |
        LINK_DIRECTORIES_CMAKE | LINK_FLAGS_CMAKE | LINK_INTERFACE_LIBRARIES_CMAKE | LINK_INTERFACE_LIBRARIES_DEBUG_CMAKE |
        LINK_INTERFACE_MULTIPLICITY_CMAKE | LINK_LIBRARIES_CMAKE | LINK_LIBRARIES_STRATEGY_CMAKE | LINK_OPTIONS_CMAKE |
        LINK_PRIVATE_CMAKE | LINK_PUBLIC_CMAKE | LIST_CMAKE | LISTS_CMAKE | LIST_DIRECTORIES_CMAKE | LIST_ONLY_CMAKE |
        LOCALE_CMAKE | LOCALSTATE_CMAKE | LOCATION_CMAKE | LOCK_CMAKE | LOG_CMAKE | LOG_DESCRIPTION_CMAKE |
        LOWER_CASE_FILE_CMAKE |

        MACOSX_BUNDLE_CMAKE | MACROS_CMAKE | MAIN_DEPENDENCY_CMAKE | MAKE_C_IDENTIFIER_CMAKE | MAKE_DIRECTORY_CMAKE |
        MAN_CMAKE | MANUALLY_ADDED_DEPENDENCIES_CMAKE | MATCH_CMAKE | MATCHALL_CMAKE | MEMBER_CMAKE | MESSAGE_CMAKE |
        MESSAGE_NEVER_CMAKE | MMX_CMAKE | MODIFIED_ACCESS_CMAKE | MODULE_CMAKE | MODULES_CMAKE | MSDN_CMAKE | MSVC_CMAKE |
        MSYS_CMAKE | MSYSTEM_CMAKE | MSYSTEM_PREFIX_CMAKE | MTIME_CMAKE | MULTI_CMAKE | MYCOMP_PROVIDER_INSTALL_DIR_CMAKE |
        MYLIBRARY_CMAKE | MY_CHECK_RESULT_CMAKE | MY_NEW_PROP_CMAKE | MY_SCRIPT_CMAKE |

        NAME_CMAKE | NAMELINK_COMPONENT_CMAKE | NAMELINK_ONLY_CMAKE | NAMELINK_SKIP_CMAKE | NAMES_CMAKE | NAMESPACE_CMAKE |
        NAMES_PER_DIR_CMAKE | NAME_WE_CMAKE | NAME_WLE_CMAKE | NATIVE_COMMAND_CMAKE | NATIVE_PATH_CMAKE | NATURAL_CMAKE |
        NETRC_CMAKE | NETRC_FILE_CMAKE | NEVER_CMAKE | NEWLINE_CONSUME_CMAKE | NEWLINE_STYLE_CMAKE | NEW_PROCESS_CMAKE |
        NNNN_CMAKE | NONE_CMAKE | NORMAL_CMAKE | NORMALIZE_CMAKE | NORMAL_PATH_CMAKE | NOTE_CMAKE | NOTEQUAL_CMAKE |
        NOTICE_CMAKE | NOT_EQUAL_CMAKE | NO_CACHE_CMAKE | NO_CMAKE_BUILDS_PATH_CMAKE | NO_CMAKE_ENVIRONMENT_PATH_CMAKE |
        NO_CMAKE_FIND_ROOT_PATH_CMAKE | NO_CMAKE_INSTALL_PREFIX_CMAKE | NO_CMAKE_PACKAGE_REGISTRY_CMAKE |
        NO_CMAKE_PATH_CMAKE | NO_CMAKE_SYSTEM_PACKAGE_REGISTRY_CMAKE | NO_CMAKE_SYSTEM_PATH_CMAKE | NO_DEFAULT_PATH_CMAKE |
        NO_HEX_CONVERSION_CMAKE | NO_LOG_CMAKE | NO_MODULE_CMAKE | NO_PACKAGE_ROOT_PATH_CMAKE | NO_POLICY_SCOPE_CMAKE |
        NO_REPLACE_CMAKE | NO_SOURCE_PERMISSIONS_CMAKE | NO_SYSTEM_ENVIRONMENT_PATH_CMAKE | NULL_CMAKE | NUMBER_CMAKE |
        NUMBER_ERRORS_CMAKE | NUMBER_OF_LOGICAL_CORES_CMAKE | NUMBER_OF_PHYSICAL_CORES_CMAKE | NUMBER_WARNINGS_CMAKE |

        OBJC_CMAKE | OBJCXX_CMAKE | OBJCXX_EXTENSIONS_CMAKE | OBJCXX_STANDARD_CMAKE | OBJCXX_STANDARD_REQUIRED_CMAKE |
        OBJC_EXTENSIONS_CMAKE | OBJC_INCLUDE_PATH_CMAKE | OBJC_STANDARD_CMAKE | OBJC_STANDARD_REQUIRED_CMAKE |
        OBJECT_CMAKE | OBJECTS_CMAKE | OBJECT_DEPENDS_CMAKE | OEM_CMAKE | OFFSET_CMAKE | ONLY_CMAKE |
        ONLY_CMAKE_FIND_ROOT_PATH_CMAKE | ONLY_IF_DIFFERENT_CMAKE | OPTIMIZE_DEPENDENCIES_CMAKE | OPTIONAL_CMAKE |
        OPTIONAL_COMPONENTS_CMAKE | OPTIONS_CMAKE | ORDER_CMAKE | ORIGIN_CMAKE | OS_NAME_CMAKE | OS_PLATFORM_CMAKE |
        OS_RELEASE_CMAKE | OS_VERSION_CMAKE | OUTPUT_CMAKE | OUTPUTS_CMAKE | OUTPUT_DIRECTORY_CMAKE | OUTPUT_FILE_CMAKE |
        OUTPUT_FORMAT_CMAKE | OUTPUT_JUNIT_CMAKE | OUTPUT_NAME_CMAKE | OUTPUT_QUIET_CMAKE |
        OUTPUT_STRIP_TRAILING_WHITESPACE_CMAKE | OUTPUT_VARIABLE_CMAKE | OVERRIDE_FIND_PACKAGE_CMAKE |
        OWNER_EXECUTE_CMAKE | OWNER_READ_CMAKE | OWNER_WRITE_CMAKE |

        PACKAGE_CMAKE | PACKAGENAME_CMAKE | PACKAGE_DEPENDENCY_CMAKE | PACKAGE_FIND_NAME_CMAKE |
        PACKAGE_FIND_VERSION_CMAKE | PACKAGE_FIND_VERSION_COMPLETE_CMAKE | PACKAGE_FIND_VERSION_COUNT_CMAKE |
        PACKAGE_FIND_VERSION_MAJOR_CMAKE | PACKAGE_FIND_VERSION_MAX_CMAKE | PACKAGE_FIND_VERSION_MAX_COUNT_CMAKE |
        PACKAGE_FIND_VERSION_MAX_MAJOR_CMAKE | PACKAGE_FIND_VERSION_MAX_MINOR_CMAKE |
        PACKAGE_FIND_VERSION_MAX_PATCH_CMAKE | PACKAGE_FIND_VERSION_MAX_TWEAK_CMAKE |
        PACKAGE_FIND_VERSION_MIN_CMAKE | PACKAGE_FIND_VERSION_MINOR_CMAKE | PACKAGE_FIND_VERSION_MIN_COUNT_CMAKE |
        PACKAGE_FIND_VERSION_MIN_MAJOR_CMAKE | PACKAGE_FIND_VERSION_MIN_MINOR_CMAKE |
        PACKAGE_FIND_VERSION_MIN_PATCH_CMAKE | PACKAGE_FIND_VERSION_MIN_TWEAK_CMAKE | PACKAGE_FIND_VERSION_PATCH_CMAKE |
        PACKAGE_FIND_VERSION_RANGE_CMAKE | PACKAGE_FIND_VERSION_RANGE_MAX_CMAKE | PACKAGE_FIND_VERSION_RANGE_MIN_CMAKE |
        PACKAGE_FIND_VERSION_TWEAK_CMAKE | PACKAGE_INFO_CMAKE | PACKAGE_VERSION_CMAKE | PACKAGE_VERSION_COMPATIBLE_CMAKE |
        PACKAGE_VERSION_EXACT_CMAKE | PACKAGE_VERSION_UNSUITABLE_CMAKE | PARALLEL_LEVEL_CMAKE | PARENT_PATH_CMAKE |
        PARENT_SCOPE_CMAKE | PARSE_ARGV_CMAKE | PARTS_CMAKE | PASS_REGULAR_EXPRESSION_CMAKE | PATH_CMAKE | PATHS_CMAKE |
        PATH_SUFFIXES_CMAKE | PATH_TO_MESA_CMAKE | PATTERN_CMAKE | PATTERNS_CMAKE | PC_LIBDIR_CMAKE | PC_PATH_CMAKE |
        PC_SYSROOT_DIR_CMAKE | PERMISSIONS_CMAKE | PERMISSIVE_CMAKE | PKGCONF_CMAKE |
        PKG_CONFIG_ALLOW_SYSTEM_CFLAGS_CMAKE | PKG_CONFIG_ALLOW_SYSTEM_LIBS_CMAKE | PKG_CONFIG_DISABLE_UNINSTALLED_CMAKE |
        PKG_CONFIG_LIBDIR_CMAKE | PKG_CONFIG_PATH_CMAKE | PKG_CONFIG_SYSROOT_DIR_CMAKE | PKG_CONFIG_SYSROOT_PATH_CMAKE |
        PKG_CONFIG_SYSTEM_INCLUDE_PATH_CMAKE | PKG_CONFIG_SYSTEM_LIBRARY_PATH_CMAKE | PKG_CONFIG_TOP_BUILD_DIR_CMAKE |
        PLATFORM_CMAKE | POLICIES_CMAKE | POLICY_CMAKE | POP_CMAKE | POP_BACK_CMAKE | POP_FRONT_CMAKE |
        POSITION_INDEPENDENT_CODE_CMAKE | POSIX_CMAKE | POST_BUILD_CMAKE | POST_EXCLUDE_FILES_CMAKE |
        POST_EXCLUDE_REGEXES_CMAKE | POST_INCLUDE_FILES_CMAKE | POST_INCLUDE_REGEXES_CMAKE | POST_INSTALL_SCRIPT_CMAKE |
        PRECOMPILE_HEADERS_CMAKE | PRECOMPILE_HEADERS_REUSE_FROM_CMAKE | PREFIX_CMAKE | PREORDER_CMAKE | PREPEND_CMAKE |
        PRETTY_NAME_CMAKE | PRE_BUILD_CMAKE | PRE_EXCLUDE_REGEXES_CMAKE | PRE_INCLUDE_REGEXES_CMAKE |
        PRE_INSTALL_SCRIPT_CMAKE | PRE_LINK_CMAKE | PRIVATE_CMAKE | PRIVATE_HEADER_CMAKE | PROCESS_CMAKE |
        PROCESSOR_DESCRIPTION_CMAKE | PROCESSOR_NAME_CMAKE | PROCESSOR_SERIAL_NUMBER_CMAKE | PROGRAM_CMAKE |
        PROGRAMS_CMAKE | PROGRAM_ARGS_CMAKE | PROJECT_CMAKE | PROJECT_BINARY_DIR_CMAKE | PROJECT_DESCRIPTION_CMAKE |
        PROJECT_HOMEPAGE_URL_CMAKE | PROJECT_IS_TOP_LEVEL_CMAKE | PROJECT_NAME_CMAKE | PROJECT_SOURCE_DIR_CMAKE |
        PROJECT_VERSION_CMAKE | PROJECT_VERSION_MAJOR_CMAKE | PROJECT_VERSION_MINOR_CMAKE | PROJECT_VERSION_PATCH_CMAKE |
        PROJECT_VERSION_TWEAK_CMAKE | PROPAGATE_CMAKE | PROPAGATE_TOP_LEVEL_INCLUDES_TO_TRY_COMPILE_CMAKE |
        PROPERTIES_CMAKE | PROPERTY_CMAKE | PUBLIC_CMAKE | PUBLIC_HEADER_CMAKE | PUSH_CMAKE |

        QUERY_CMAKE | QUIET_CMAKE |

        RANDOM_CMAKE | RANDOM_SEED_CMAKE | RANGE_CMAKE | RANGE_END_CMAKE | RANGE_START_CMAKE | READ_CMAKE |
        READ_ACCESS_CMAKE | READ_SYMLINK_CMAKE | READ_WITH_PREFIX_CMAKE | REALPATH_CMAKE | REAL_PATH_CMAKE |
        REGEX_CMAKE | REGISTRY_VIEW_CMAKE | REGULAR_EXPRESSION_CMAKE | REG_DWORD_CMAKE | REG_EXPAND_SZ_CMAKE |
        REG_MULTI_SZ_CMAKE | REG_QWORD_CMAKE | REG_SZ_CMAKE | RELATIVE_CMAKE | RELATIVE_PART_CMAKE | RELATIVE_PATH_CMAKE |
        RELEASE_CMAKE | REMOVE_CMAKE | REMOVED_ACCESS_CMAKE | REMOVE_AT_CMAKE | REMOVE_DUPLICATES_CMAKE |
        REMOVE_EXTENSION_CMAKE | REMOVE_FILENAME_CMAKE | REMOVE_ITEM_CMAKE | REMOVE_RECURSE_CMAKE | RENAME_CMAKE |
        REPEAT_CMAKE | REPLACE_CMAKE | REPLACE_EXTENSION_CMAKE | REPLACE_FILENAME_CMAKE | REQUIRED_CMAKE | REQUIRES_CMAKE |
        RESOLVED_DEPENDENCIES_VAR_CMAKE | RESOURCE_CMAKE | RESOURCE_SPEC_FILE_CMAKE | RESULT_CMAKE |
        RESULTS_VARIABLE_CMAKE | RESULTVAR_CMAKE | RESULT_VARIABLE_CMAKE | RETRY_COUNT_CMAKE | RETRY_DELAY_CMAKE |
        RETURN_VALUE_CMAKE | REUSE_FROM_CMAKE | REVERSE_CMAKE | ROOT_DIRECTORY_CMAKE | ROOT_NAME_CMAKE | ROOT_PATH_CMAKE |
        RPATH_CMAKE | RUNPATH_CMAKE | RUNSTATE_CMAKE | RUNTIME_CMAKE | RUNTIME_DEPENDENCIES_CMAKE |
        RUNTIME_DEPENDENCY_SET_CMAKE | RUNTIME_DIRECTORY_CMAKE | RUNTIME_OUTPUT_DIRECTORY_CMAKE |
        RUN_OUTPUT_STDERR_VARIABLE_CMAKE | RUN_OUTPUT_STDOUT_VARIABLE_CMAKE | RUN_OUTPUT_VARIABLE_CMAKE |

        SBIN_CMAKE | SCHEDULE_RANDOM_CMAKE | SCOPE_FOR_CMAKE | SCRIPT_CMAKE | SELECTOR_CMAKE | SEND_ERROR_CMAKE |
        SENSITIVE_CMAKE | SEPARATE_ARGS_CMAKE | SEPARATOR_CMAKE | SET_CMAKE | SETGID_CMAKE | SETUID_CMAKE | SETUP_CMAKE |
        SET_DEPENDENCY_PROVIDER_CMAKE | SHARED_CMAKE | SHAREDSTATE_CMAKE | SHELL_CMAKE | SHOW_PROGRESS_CMAKE | SIZE_CMAKE |
        SKIP_PRECOMPILE_HEADERS_CMAKE | SKIP_REGULAR_EXPRESSION_CMAKE | SOFTWARE_CMAKE | SONAME_CMAKE | SORT_CMAKE |
        SOURCE_CMAKE | SOURCES_CMAKE | SOURCES_TYPE_CMAKE | SOURCE_DATE_EPOCH_CMAKE | SOURCE_DIR_CMAKE |
        SOURCE_FROM_CONTENT_CMAKE | SOURCE_FROM_FILE_CMAKE | SOURCE_FROM_VAR_CMAKE | SOVERSION_CMAKE | START_CMAKE |
        STATIC_CMAKE | STATIC_LIBRARY_CMAKE | STATIC_LIBRARY_OPTIONS_CMAKE | STATUS_CMAKE | STDERR_CMAKE | STDOUT_CMAKE |
        STEM_CMAKE | STOP_ON_FAILURE_CMAKE | STOP_TIME_CMAKE | STRICT_CMAKE | STRICTNESS_CMAKE | STRIDE_CMAKE |
        STRING_CMAKE | STRINGS_CMAKE | STRIP_CMAKE | SUBKEYS_CMAKE | SUBLIST_CMAKE | SUBMIT_URL_CMAKE | SUBSTRING_CMAKE |
        SUPPORTED_METHODS_CMAKE | SYMBOLIC_CMAKE | SYSCONF_CMAKE | SYSTEM_CMAKE | SYSTEM_INCLUDE_DIRS_CMAKE |
        SYSTEM_LIBRARY_DIRS_CMAKE |

        TARGETS_CMAKE | TARGET_DIRECTORY_CMAKE | TARGET_FILE_CMAKE | TARGET_LINKER_FILE_CMAKE | TARGET_OBJECTS_CMAKE |
        TARGET_PDB_FILE_CMAKE | TARGET_PROPERTY_CMAKE | TARGET_RUNTIME_DLLS_CMAKE | TARGET_SONAME_FILE_CMAKE |
        TEST_LAUNCHER_CMAKE | TEST_LOAD_CMAKE | TEST_VARIABLE_CMAKE | TIMEOUT_CMAKE | TIMESTAMP_CMAKE | TLS_CAINFO_CMAKE |
        TLS_VERIFY_CMAKE | TLS_VERSION_CMAKE | TOLOWER_CMAKE | TOOLCHAINS_CMAKE | TOP_BUILD_DIR_CMAKE |
        TOTAL_PHYSICAL_MEMORY_CMAKE | TOTAL_VIRTUAL_MEMORY_CMAKE | TOUCH_CMAKE | TOUCH_NOCREATE_CMAKE | TOUPPER_CMAKE |
        TO_CMAKE_PATH_CMAKE | TO_CMAKE_PATH_LIST_CMAKE | TO_NATIVE_PATH_CMAKE | TO_NATIVE_PATH_LIST_CMAKE | TRACE_CMAKE |
        TRACK_CMAKE | TRANSFORM_CMAKE | TRANSFORM_APPEND_CMAKE | TRANSFORM_GENEX_STRIP_CMAKE | TRANSFORM_REPLACE_CMAKE |
        TRANSFORM_STRIP_CMAKE | TRANSFORM_TOLOWER_CMAKE | TREE_CMAKE | TYPE_CMAKE |

        UNIX_CMAKE | UNIX_COMMAND_CMAKE | UNKNOWN_CMAKE | UNKNOWN_MODIFIED_ACCESS_CMAKE | UNKNOWN_READ_ACCESS_CMAKE |
        UNRESOLVED_DEPENDENCIES_VAR_CMAKE | UNSET_CMAKE | UNTIL_FAIL_CMAKE | UNTIL_PASS_CMAKE | UPLOAD_CMAKE |
        UPPER_CMAKE | USERPROFILE_CMAKE | USERPWD_CMAKE | USES_TERMINAL_CMAKE | USE_SOURCE_PERMISSIONS_CMAKE |
        UTC_CMAKE | UUID_CMAKE |

        VALIDATOR_CMAKE | VALUE_CMAKE | VALUE_NAMES_CMAKE | VARIABLE_CMAKE | VARIABLES_CMAKE | VERBATIM_CMAKE |
        VERBOSE_CMAKE | VERSION_CMAKE | VERSION_SCHEMA_CMAKE | VIEW_CMAKE |

        WARNING_CMAKE | WILL_FAIL_CMAKE | WINDOWS_COMMAND_CMAKE | WINDOWS_REGISTRY_CMAKE | WORKING_DIRECTORY_CMAKE |
        WORLD_EXECUTE_CMAKE | WORLD_READ_CMAKE | WORLD_WRITE_CMAKE | WRITE_CMAKE | WRONG_CMAKE |
