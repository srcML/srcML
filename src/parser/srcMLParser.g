...
enum STMT_TYPE { 
    ...
    USING_STMT, OPERATOR_FUNCTION, OPERATOR_FUNCTION_DECL, EVENT_STMT, PROPERTY_STATEMENT
};
...
pattern_check_core[int& token,      /* second token, after name (always returned) */
        ...
        */
        ...
        // check if property
        set_type[type, PROPERTY_STATEMENT, inLanguage(LANGUAGE_CSHARP) && (type_count - specifier_count) > 0 && LA(1) == LCURLY]
        throw_exception[type == PROPERTY_STATEMENT]
