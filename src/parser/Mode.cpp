...
// Rust
const srcMLState::MODE_TYPE ModeStack::MODE_DECL_STATEMENT_RS       (bit(__COUNTER__));
const srcMLState::MODE_TYPE ModeStack::MODE_DECL_RS                 (bit(__COUNTER__));
const srcMLState::MODE_TYPE ModeStack::MODE_FUNCTION_RS             (bit(__COUNTER__));
const srcMLState::MODE_TYPE ModeStack::MODE_FUNCTION_DECLARATION_RS (bit(__COUNTER__));
const srcMLState::MODE_TYPE ModeStack::MODE_FUNCTION_DEFINITION_RS  (bit(__COUNTER__));
...
const srcMLState::MODE_TYPE ModeStack::MODE_UNIT_STRUCT_RS          (bit(__COUNTER__));
...
const srcMLState::MODE_TYPE ModeStack::MODE_TRAIT_RS                (bit(__COUNTER__));
