...
// const srcMLState::MODE_TYPE ModeStack::MODE_UNUSED           = ull(0x0000080000000000);
...
// const srcMLState::MODE_TYPE ModeStack::MODE_UNUSED           = ull(0x0004000000000000);
// const srcMLState::MODE_TYPE ModeStack::MODE_UNUSED           = ull(0x0008000000000000);
const srcMLState::MODE_TYPE ModeStack::MODE_INNER_DECL          = ull(0x0010000000000000);
// const srcMLState::MODE_TYPE ModeStack::MODE_UNUSED           = ull(0x0020000000000000);
// const srcMLState::MODE_TYPE ModeStack::MODE_UNUSED           = ull(0x0040000000000000);
