...
const srcMLState::MODE_TYPE ModeStack::MODE_PROPERTY                  (bit(__COUNTER__));
...
const srcMLState::MODE_TYPE ModeStack::MODE_IIFE_INNER_JS              (bit(__COUNTER__));
...
const srcMLState::MODE_TYPE ModeStack::MODE_RETURN_JS                  (bit(__COUNTER__));
