...
const State::MODE_TYPE Mode::MODE_ARGUMENT_LIST       = ull(0x0000040000000000);
// const State::MODE_TYPE Mode::MODE_UNUSED           = ull(0x0000080000000000);
...
// const State::MODE_TYPE Mode::MODE_UNUSED           = ull(0x0008000000000000);
