...
const srcMLState::MODE_TYPE ModeStack::MODE_FOR_GROUP                 (std::string("0000000000000000000000000000000000000000000100000000000000000000"));
...
// const srcMLState::MODE_TYPE ModeStack::MODE_GUESSING               (std::string("0000000000000000000000000001000000000000000000000000000000000000"));
