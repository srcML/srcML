...
#define SRCML_OPTION_CPP               1<<28 | 1<<21/*1<<7  /* Markup preprocessor elements (default for C, C++, C#) */
#define SRCML_OPTION_CPP_NOMACRO       1<<21/*1<<7  /* Markup preprocessor elements (default for C, C++, C#) */
