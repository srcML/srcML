...
__LIBSRCML_DECL int srcml_append_transform_xslt_memory     (struct srcml_archive*, const char* xslt_buffer);
__LIBSRCML_DECL int srcml_append_transform_xslt_FILE       (struct srcml_archive*, const char* xslt_file);
__LIBSRCML_DECL int srcml_append_transform_xslt_fd         (struct srcml_archive*, const char* xslt_fd);
__LIBSRCML_DECL int srcml_append_transform_relaxng_filename(struct srcml_archive*, const char* relaxng_filename);
__LIBSRCML_DECL int srcml_append_transform_relaxng_memory  (struct srcml_archive*, const char* relaxng_buffer);
__LIBSRCML_DECL int srcml_append_transform_relaxng_FILE    (struct srcml_archive*, const char* relaxng_file);
__LIBSRCML_DECL int srcml_append_transform_relaxng_fd      (struct srcml_archive*, const char* relaxng_fd);
