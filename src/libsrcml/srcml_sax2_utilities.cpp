 ...
 */
int srcml_extract_text(const char * input_buffer, size_t size, UTF8Source & output_handler, OPTION_TYPE options, int unit) {
...
int srcml_extract_text_filename(const char * ifilename, const char * ofilename, const char * encoding, OPTION_TYPE options, int unit) {
    ...
    UTF8Source output_handler(ofilename, encoding);
