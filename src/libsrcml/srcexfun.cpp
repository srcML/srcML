...
void xpathsrcMLRegister(xmlXPathContextPtr context) {
    ...
    xpathRegisterExtensionFunction(SRCML_SRC_NS_URI, "is_private",
        ...
        "("
            ...
            "("
                ...
                " or "
                "("
                    "(self::src:class or self::src:class_decl or self::src:annotation_def)"
                    " and "
                    "("
                        "src:specifier[.='private']"
                        " or "
    ...
    xpathRegisterExtensionFunction(SRCML_SRC_NS_URI, "is_member", "(ancestor::src:unit[@language[.='C' or .='Java' or .='C#']] and (parent::src:block[ parent::src:enum or parent::src:struct or parent::src:union or parent::src:class ] or parent::src:decl_stmt[ parent::src:block[ parent::src:enum or parent::src:struct or parent::src:union or parent::src:class] ] or ((self::src:function or self::src:function_decl) and parent::src:block[ parent::src:property[parent::src:block[ parent::src:enum or parent::src:struct or parent::src:union or parent::src:class ]] or parent::src:event[parent::src:block[ parent::src:enum or parent::src:struct or parent::src:union or parent::src:class ]]]))) or ( ancestor::src:unit[@language='C++'] and ( parent::src:public or parent::src:protected or parent::src:private or parent::src:decl_stmt[ parent::src:public or parent::src:protected or parent::src:private ] or parent::src:block[parent::src:enum] ) )");
