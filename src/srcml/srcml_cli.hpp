...
#define SRCML_COMMAND_DISPLAY_SRCML_LANGUAGE    1<<22
#define SRCML_COMMAND_DISPLAY_SRCML_DIRECTORY   1<<23
#define SRCML_COMMAND_DISPLAY_SRCML_FILENAME    1<<24
#define SRCML_COMMAND_DISPLAY_SRCML_SRC_VERSION 1<<25
#define SRCML_COMMAND_DISPLAY_SRCML_ENCODING    1<<26
