...
const State::MODE_TYPE Mode::MODE_INNER_DECL          = 0x0010000000000000ULL;
const State::MODE_TYPE Mode::MODE_REQUIRES            = 0x0020000000000000ULL;
const State::MODE_TYPE Mode::MODE_CONCEPT             = 0x0040000000000000ULL;
