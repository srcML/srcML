...
#ifndef SRCML_H_INCLUDED
#define SRCML_H_INCLUDED
...
int src2srcml(char* src_filename, char* srcml_filename, int options, char* language, char* src_encoding, char* attributes[][2]);

/* list of source code files converted to a srcML archive file */
int src2srcml(char* src_filenames[], char* srcmlfilename, char* language, char* src_encoding, int options);

/* source code file converted to an individual srcML buffer */
int src2srcml(char* src_filename, char** srcml_buffer, char* language, char* src_encoding, int options);

/* source code buffer converted to a srcML file */
int src2srcml(char* src_buffer, char* srcml_filename, char* language, char* src_encoding, int options);

/* source code buffer to the individual srcML format */
int src2srcml(char* src_buffer, char** srcml_buffer, char* language, char* src_encoding, int options);
...
char* [][2] srcml_info(char* srcml_filename);
