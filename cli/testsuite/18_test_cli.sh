...
define nestedfileextra <<- 'STDIN'
	...
	<unit xmlns:cpp="http://www.sdml.info/srcML/cpp" revision="0.8.0" language="C" dir="sub" filename="a.cpp" hash="1a2c5d67e6f651ae10b7673c53e8c502c97316d6">
	<expr_stmt><expr><name>a</name></expr>;</expr_stmt>
	</unit>

	<unit xmlns:cpp="http://www.sdml.info/srcML/cpp" revision="0.8.0" language="Java" dir="sub" filename="b.cpp" hash="aecf18b52d520ab280119febd8ff6c803135ddfc">
...
srcml2src --unit "1" --get-filename <<< "$nestedfileextra"

check 3<<< "a.cpp"

srcml2src --unit "2" --get-filename <<< "$nestedfileextra"

check 3<<< "b.cpp"

srcml2src --unit "1" --get-directory <<< "$nestedfileextra"

check 3<<< "sub"

srcml2src --unit "2" --get-directory <<< "$nestedfileextra"

check 3<<< "sub"

srcml2src --unit "1" --get-language <<< "$nestedfileextra"

check 3<<< "C"
	
srcml2src --unit "2" --get-language <<< "$nestedfileextra"
