...
define result <<- 'STDOUT'
	...
	<unit xmlns="http://www.srcML.org/srcML/src" xmlns:foo="foo.com" revision="0.8.0">

	<unit xmlns:cpp="http://www.srcML.org/srcML/cpp" revision="0.8.0" language="C++"><expr_stmt><expr><foo:foo><name>a</name></foo:foo></expr>;</expr_stmt>
	</unit>
