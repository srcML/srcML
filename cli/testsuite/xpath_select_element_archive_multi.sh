...
define output <<- 'STDOUT'
	...
	<unit xmlns:cpp="http://www.srcML.org/srcML/cpp" revision="0.8.0" language="C++" filename="b.cpp" item="1">LIBSRCML_DECL</unit>

	<unit xmlns:cpp="http://www.srcML.org/srcML/cpp" revision="0.8.0" language="C++" filename="b.cpp" item="2">int</unit>
