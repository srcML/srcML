...
define foutput <<- 'STDOUT'
	...
	<unit xmlns="http://www.srcML.org/srcML/src" revision="REVISION" filename="file://archive/a.cpp.tar.gz">
...
src2srcml archive/a.cpp.tar.gz
check 3<<< "$foutput"

src2srcml -l C++ < archive/a.cpp.tar.gz
check 3<<< "$output"

src2srcml -l C++ -o archive/a.cpp.xml < archive/a.cpp.tar.gz
