...
srcml2src -X --unit "1" --get-language sub/a.cpp.xml
check 3<<< "C++"

srcml2src -X --unit "1" --get-directory sub/a.cpp.xml
check 3<<< "sub"

srcml2src -X --unit "1" --get-filename sub/a.cpp.xml
check 3<<< "a.cpp"

srcml2src -X --unit "2" --get-language sub/a.cpp.xml
check 3<<< "Java"

srcml2src -X --unit "2" --get-directory sub/a.cpp.xml
check 3<<< "emptysrc"

srcml2src -X --unit "2" --get-filename sub/a.cpp.xml
check 3<<< "empty.java"
