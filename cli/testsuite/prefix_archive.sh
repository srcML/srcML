...
# from a file
srcml -U 1 -X -p "http://www.sdml.info/srcML/cpp" sub/a.xml
check 3<<< "cpp"

srcml sub/a.xml -U 1 -X -p "http://www.sdml.info/srcML/cpp"
check 3<<< "cpp"
...
# standard in
srcml2src -U 1 -X -p "http://www.sdml.info/srcML/cpp" <<< "$input"
check 3<<< "cpp"

srcml2src -U 1 -X --prefix "http://www.sdml.info/srcML/cpp" <<< "$input"
check 3<<< "cpp"
...
srcml -U 1 -X -p "http://www.sdml.info/srcML/cpp" sub/archive_multi.xml
check 3<<< "cpp"

srcml sub/archive_multi.xml -U 1 -X -p "http://www.sdml.info/srcML/cpp"
check 3<<< "cpp"

srcml -p "http://www.sdml.info/srcML/src" sub/archive_multi.xml
check 3<<< ""

srcml sub/archive_multi.xml -p "http://www.sdml.info/srcML/src"
check 3<<< ""
...
# standard in
srcml2src -U 1 -X  -p "http://www.sdml.info/srcML/cpp" <<< "$archive_multi"
check 3<<< "cpp"

srcml2src -U 1 -X --prefix "http://www.sdml.info/srcML/cpp" <<< "$archive_multi"
check 3<<< "cpp"

srcml2src -U 1 -X --prefix="http://www.sdml.info/srcML/cpp" <<< "$archive_multi"
check 3<<< "cpp"

srcml2src -p "http://www.sdml.info/srcML/src" <<< "$archive_multi"
check 3<<< ""

srcml2src --prefix "http://www.sdml.info/srcML/src" <<< "$archive_multi"
check 3<<< ""
