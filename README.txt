...
* # Parts of srcML #
	...
	* libsrcml
    	...
    	The library provides a C interface for translation of source code to and from srcML, as well as, efficient manipulation and fact extraction (XPath, XSLT, and RelaxNG).  The client srcml is build utilizing libsrcml.
