...
variable "distributions" {
  ...
  default = [
    ...
    { id = "opensuse", version_id = "16.0",   java_version_id="15.6",  name = "OpenSUSE 16.0", workflow = "rpm",    opensuse="leap", tag = "latest" },
    { id = "opensuse", version_id = "15.6",   java_version_id="15.6",  name = "OpenSUSE 15.6", workflow = "rpm",    opensuse="leap" },
    ...
    { id = "opensuse", version_id = "tumbleweed", java_version_id="latest",  name = "OpenSUSE Tumbleweed", workflow = "rpm",    opensuse="tumbleweed", base_tag = "latest" }
  ]
}
