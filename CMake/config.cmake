...
if(${CMAKE_COMPILER_IS_GNUCXX})
    ...
    set(CMAKE_CXX_FLAGS "${USE_FPIC} -O3 -DTEST ${GCC_WARNINGS}")
    set(CMAKE_CXX_FLAGS_RELEASE "${USE_FPIC} -O3 -DNDEBUG ${GCC_WARNINGS}")
    set(CMAKE_CXX_FLAGS_DEBUG "${USE_FPIC} -O3 -g -DDEBUG -DTEST --coverage -fprofile-arcs ${GCC_WARNINGS}")

elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
    # Configuring the Clang compiler
    set(CLANG_WARNINGS "-Wno-long-long -Wall -Wextra -Wshorten-64-to-32 -Wno-unknown-pragmas")
    set(CMAKE_CXX_FLAGS "-fPIC -O3 --std=c++11 -DTEST ${CLANG_WARNINGS}")
    set(CMAKE_CXX_FLAGS_RELEASE "-fPIC -O3 -DNDEBUG ${CLANG_WARNINGS}")
    set(CMAKE_CXX_FLAGS_DEBUG "-fPIC -O0 -g -DDEBUG -DTEST ${CLANG_WARNINGS}")
...
elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
    ...
    set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS} ${MSVC_WARNINGS} /DTEST /Od /ZI /MDd")
