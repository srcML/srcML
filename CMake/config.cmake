...
elseif(NOT "${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
    set(SRCML_LIBRARIES ${LibArchive_LIBRARIES} ${Boost_FILESYSTEM_LIBRARY_RELEASE} ${Boost_PROGRAM_OPTIONS_LIBRARY_RELEASE} ${CURL_LIBRARIES} ws2_32 crypto CACHE INTERNAL "Libraries needed to build srcml")
else()
