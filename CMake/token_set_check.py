...
set(['ELIF', 'GROUP', 'JOIN', 'REGION', 'LINE', 'FINAL', 'SELECT', 'SET', 'GET', 'ASCENDING', 'OVERRIDE',
    ...
    'REMOVE', 'LET', 'IFDEF', 'IFNDEF', 'SUPER', 'UNCHECKED', 'VOID', 'CRESTRICT', 'ASM']),
...
set(['VOLATILE', 'LBRACKET', 'PROTECTED', 'LINE', 'BY', 'DEFINE', 'CHECKED', 'ENUM', 'ENDIF', 'WHERE', 'ON',
    ...
    'UNSAFE', 'STATIC', 'MUTABLE', 'DCOLON', 'FINAL', 'SELECT', 'GET', 'EXPLICIT', 'READONLY', 'LET', 'ORDERBY',
    'RVALUEREF', 'UNDEF', 'UNION', 'EQUALS', 'VIRTUAL', 'OPERATOR', 'INCLUDE', 'ERRORPREC', 'DOTDOTDOT', 'REMOVE',
    'PUBLIC', 'DELEGATE', 'IFNDEF', 'UNCHECKED', 'LPAREN', 'DEFAULT', 'DESTOP', 'EXTERN', 'NEW', 'REF', 'NATIVE',
    'SET', 'ASCENDING', 'STRICTFP', 'FRIEND', 'OUT', 'ADD', 'DESCENDING', 'ASYNC', 'JOIN', 'NAME', 'QMARK',
    'INTERNAL', 'PARAMS', 'INLINE', 'EVENT', 'ELIF', 'CONST', 'ABSTRACT', 'REFOPS', 'MULTOPS', 'PRIVATE',
...
set(['EXTERN', 'RESTRICT', 'CONSTEXPR', 'THREAD_LOCAL', 'ALIGNAS', 'INLINE', 'MACRO_SPECIFIER',
     ...
     'EVENT', 'ASYNC', 'PARAMS', 'CRESTRICT', 'COMPLEX', 'NORETURN', 'IMAGINARY', 'ENUM'])]
