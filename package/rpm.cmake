...
set(CPACK_RPM_SRCMLLIB_PACKAGE_NAME "lib${CPACK_PACKAGE_NAME}${PROJECT_VERSION_MAJOR}")
set(CPACK_RPM_SRCMLDEV_PACKAGE_NAME "${CPACK_RPM_SRCMLLIB_PACKAGE_NAME}-devel")
...
if(DISTRO MATCHES "CentOS|Fedora")
    ...
    set(CPACK_RPM_SRCMLLIB_FILE_NAME RPM-DEFAULT)
    ...
    set(CPACK_ARCHIVE_SRCMLLIB_FILE_NAME "${CPACK_RPM_SRCMLLIB_PACKAGE_NAME}-${PROJECT_VERSION}-${CPACK_RPM_PACKAGE_RELEASE}")
    ...
    add_custom_target(gen_package
       ...
       COMMAND bash -c "mv dist/${CPACK_ARCHIVE_SRCMLLIB_FILE_NAME}.tar.gz dist/`rpm --specfile dist/_CPack_Packages/Linux/RPM/SPECS/${CPACK_RPM_SRCMLLIB_PACKAGE_NAME}.spec`.tar.gz"
       COMMAND bash -c "mv dist/${CPACK_ARCHIVE_SRCMLLIB_FILE_NAME}.tar.bz2 dist/`rpm --specfile dist/_CPack_Packages/Linux/RPM/SPECS/${CPACK_RPM_SRCMLLIB_PACKAGE_NAME}.spec`.tar.bz2"
    ...
    set(BASE_SRCMLLIB_FILE_NAME "${CPACK_RPM_SRCMLLIB_PACKAGE_NAME}-${PROJECT_VERSION}-${CPACK_RPM_PACKAGE_RELEASE}.${RPM_VERSION}")
    set(BASE_SRCMLDEV_FILE_NAME "${CPACK_RPM_SRCMLDEV_PACKAGE_NAME}-${PROJECT_VERSION}-${CPACK_RPM_PACKAGE_RELEASE}.${RPM_VERSION}")
    set(CPACK_RPM_SRCML_FILE_NAME "${BASE_SRCML_FILE_NAME}.rpm")
    set(CPACK_RPM_SRCMLLIB_FILE_NAME "${BASE_SRCMLLIB_FILE_NAME}.rpm")
...
set(CPACK_RPM_SRCMLLIB_PACKAGE_URL ${CMAKE_PROJECT_HOMEPAGE_URL})
set(CPACK_RPM_SRCMLDEV_PACKAGE_URL ${CMAKE_PROJECT_HOMEPAGE_URL})

# Package groups
# @TODO Why is this not "SRCML/Tools"?
set(CPACK_RPM_SRCML_PACKAGE_GROUP "SRCMLDEV/Tools")
set(CPACK_RPM_SRCMLLIB_PACKAGE_GROUP "SRCMLLIB/Libraries")
