...
set(CPACK_DEBIAN_SRCMLLIB_PACKAGE_NAME "lib${CPACK_PACKAGE_NAME}${PROJECT_VERSION_MAJOR}")
set(CPACK_DEBIAN_SRCMLDEV_PACKAGE_NAME "${CPACK_DEBIAN_SRCMLLIB_PACKAGE_NAME}-dev")
...
set(BASE_SRCMLLIB_FILE_NAME "${CPACK_DEBIAN_SRCMLLIB_PACKAGE_NAME}_${PROJECT_VERSION}-${CPACK_DEBIAN_PACKAGE_RELEASE}_${DEBIAN_VERSION}")
...
set(CPACK_DEBIAN_SRCMLLIB_FILE_NAME "${BASE_SRCMLLIB_FILE_NAME}.deb")
set(CPACK_DEBIAN_SRCMLDEV_FILE_NAME "${BASE_SRCMLDEV_FILE_NAME}.deb")
set(CPACK_ARCHIVE_SRCML_FILE_NAME "${BASE_SRCML_FILE_NAME}")
set(CPACK_ARCHIVE_SRCMLLIB_FILE_NAME "${BASE_SRCMLLIB_FILE_NAME}")
...
set(CPACK_DEBIAN_SRCMLLIB_PACKAGE_SECTION "devel")
...
set(CPACK_DEBIAN_SRCMLLIB_PACKAGE_PRIORITY "optional")
...
set(CPACK_DEBIAN_SRCML_PACKAGE_DEPENDS "${CPACK_DEBIAN_SRCMLLIB_PACKAGE_NAME}${CMAKE_MAJOR_VERSION} (>= ${PROJECT_VERSION})")
set(CPACK_DEBIAN_SRCMLDEV_PACKAGE_DEPENDS "${CPACK_DEBIAN_SRCMLLIB_PACKAGE_NAME}${CMAKE_MAJOR_VERSION} (>= ${PROJECT_VERSION})")
...
set(CPACK_DEBIAN_SRCMLLIB_PACKAGE_CONTROL_EXTRA "${TRIGGERS_FILE}")
