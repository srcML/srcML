...
int main() {
    ...
    const std::string srcdiff_single_a = "<unit xmlns=\"http://www.srcML.org/srcML/src\" xmlns:cpp=\"http://www.srcML.org/srcML/cpp\" xmlns:diff=\"http://www.srcML.org/srcDiff\" language=\"C++\" url=\"test\" filename=\"a.cpp|b.cpp\" version=\"1|2\" tabs=\"4\" timestamp=\"today\" hash=\"abc\" foo=\"bar\"><diff:delete type=\"change\"><expr_stmt><expr><name>a</name></expr>;</expr_stmt></diff:delete><diff:insert type=\"change\"><expr_stmt><expr><name>b</name></expr>;</expr_stmt></diff:insert>\n</unit>";
    const std::string srcdiff_single_a_original = "<unit xmlns=\"http://www.srcML.org/srcML/src\" xmlns:cpp=\"http://www.srcML.org/srcML/cpp\" language=\"C++\" url=\"test\" filename=\"a.cpp\" version=\"1\" tabs=\"4\" timestamp=\"today\" hash=\"abc\" foo=\"bar\"><expr_stmt><expr><name>a</name></expr>;</expr_stmt>\n</unit>";
    const std::string srcdiff_single_a_modified = "<unit xmlns=\"http://www.srcML.org/srcML/src\" xmlns:cpp=\"http://www.srcML.org/srcML/cpp\" language=\"C++\" url=\"test\" filename=\"b.cpp\" version=\"2\" tabs=\"4\" timestamp=\"today\" hash=\"abc\" foo=\"bar\"><expr_stmt><expr><name>b</name></expr>;</expr_stmt>\n</unit>";
    const std::string srcdiff_single = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n<unit xmlns=\"http://www.srcML.org/srcML/src\" xmlns:cpp=\"http://www.srcML.org/srcML/cpp\" xmlns:diff=\"http://www.srcML.org/srcDiff\" language=\"C++\" url=\"test\" filename=\"a.cpp|b.cpp\" version=\"1|2\" tabs=\"4\" timestamp=\"today\" hash=\"abc\" foo=\"bar\"><diff:delete type=\"change\"><expr_stmt><expr><name>a</name></expr>;</expr_stmt></diff:delete><diff:insert type=\"change\"><expr_stmt><expr><name>b</name></expr>;</expr_stmt></diff:insert>\n</unit>\n";
    ...
    std::ofstream srcml_file_srcdiff_single("project_srcdiff_single.xml");
    srcml_file_srcdiff_single << srcdiff_single;
    srcml_file_srcdiff_single.close();
    ...
    */
    ...
    {
        srcml_sax2_reader reader("project_srcdiff_single.xml");
        boost::optional<std::string> encoding, language, directory, version;
        std::vector<std::string> attributes;
        std::vector<std::string> prefixes;
        std::vector<std::string> namespaces;
    ...
    {
        boost::optional<size_t> revision_number(SRCDIFF_REVISION_ORIGINAL);
        srcml_sax2_reader reader("project_srcdiff_single.xml", 0, revision_number);
        boost::optional<std::string> encoding, language, directory, version;
        std::vector<std::string> attributes;
        std::vector<std::string> prefixes;
        std::vector<std::string> namespaces;
