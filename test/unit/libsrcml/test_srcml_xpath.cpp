    ...
    */
...

    {
        ...
        dassert(output, "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n"
                        ...
                        "<unit language=\"C++\" filename=\"a.cpp\" item=\"2\" xpath=\"/src:unit[1]/src:function_decl[2]\"><function_decl><type><name>void</name></type> <name>g</name><parameter_list>(<param><decl><type><name>int</name></type> <name>a</name></decl></param>, <param><decl><type><name>double</name></type> <name>b</name></decl></param>)</parameter_list>;</function_decl></unit>\n\n"
...

    {
        ...
        xmlParserInputBufferPtr buffer_input = xmlParserInputBufferCreateFilename("input.xml", xmlParseCharEncoding(0));
        int fd = OPEN("project.xml", O_WRONLY | O_CREAT | O_TRUNC, S_IRUSR | S_IWUSR);
        dassert(srcml_xpath(buffer_input, "src:unit", "//src:function_decl[src:name='g']", fd, SRCML_OPTION_XML_DECL | SRCML_OPTION_NAMESPACE_DECL), SRCML_STATUS_OK);
        std::ifstream in("project.xml");
        std::string output;
        char temp;
        while(in.get(temp))
        ...
        dassert(output, "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n"
                        "<unit xmlns=\"http://www.sdml.info/srcML/src\">\n\n"
                        "<unit language=\"C++\" filename=\"a.cpp\" item=\"1\" xpath=\"/src:unit[1]/src:function_decl[2]\"><function_decl><type><name>void</name></type> <name>g</name><parameter_list>(<param><decl><type><name>int</name></type> <name>a</name></decl></param>, <param><decl><type><name>double</name></type> <name>b</name></decl></param>)</parameter_list>;</function_decl></unit>\n\n"
                        "</unit>\n");
        xmlFreeParserInputBuffer(buffer_input);
        UNLINK("input.xml");
        UNLINK("project.xml");
...

    {
        ...
        xmlParserInputBufferPtr buffer_input = xmlParserInputBufferCreateFilename("input.xml", xmlParseCharEncoding(0));
        int fd = OPEN("project.xml", O_WRONLY | O_CREAT | O_TRUNC, S_IRUSR | S_IWUSR);
        dassert(srcml_xpath(buffer_input, "src:unit", "//src:function_decl//src:param[src:decl/src:name='b']", fd, SRCML_OPTION_XML_DECL | SRCML_OPTION_NAMESPACE_DECL), SRCML_STATUS_OK);
        std::ifstream in("project.xml");
        std::string output;
        char temp;
        while(in.get(temp))
        ...
        dassert(output, "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n"
                        "<unit xmlns=\"http://www.sdml.info/srcML/src\">\n\n"
                        "<unit language=\"C++\" filename=\"a.cpp\" item=\"1\" xpath=\"/src:unit[1]/src:function_decl[2]/src:parameter_list[1]/src:param[2]\"><param><decl><type><name>double</name></type> <name>b</name></decl></param></unit>\n\n"
                        "</unit>\n");
        xmlFreeParserInputBuffer(buffer_input);
        UNLINK("input.xml");
        UNLINK("project.xml");
