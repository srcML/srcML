...
int main() {
    ...
    */
    ...
    {
        dassert(srcml_archive_set_encoding(0, "foo"), SRCML_STATUS_INVALID_ARGUMENT);
    }
    ...
    */

    {
        ...
        dassert(archive->registered_languages.last().first, "foo");
        dassert(archive->registered_languages.last().second, 2);
        srcml_free_archive(archive);
    }
