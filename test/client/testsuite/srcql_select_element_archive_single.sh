...
#
# @file srcql_select_element_archive_single.sh
#
...
srcml --srcql='$C($N)' --xpath "//src:argument/src:expr/src:name" sub/archive.cpp.xml
check "$output"

srcml sub/archive.cpp.xml --srcql='$C($N)' --xpath "//src:argument/src:expr/src:name" -o sub/a.xml
check sub/a.xml "$output"

srcml --srcql='$C($N)' --xpath "//src:argument/src:expr/src:name" sub/archive.cpp.xml -o sub/a.xml
check sub/a.xml "$output"

srcml sub/archive.cpp.xml -o sub/a.xml --srcql='$C($N)' --xpath "//src:argument/src:expr/src:name"
check sub/a.xml "$output"

srcml -o sub/a.xml sub/archive.cpp.xml --srcql='$C($N)' --xpath "//src:argument/src:expr/src:name"
check sub/a.xml "$output"
