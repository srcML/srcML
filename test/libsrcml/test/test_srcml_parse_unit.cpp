...
int main() {
    ...
    const std::string srcml_timestamp = "<unit xmlns:cpp=\"http://www.sdml.info/srcML/cpp\" timestamp=\"today\" language=\"C\"><expr_stmt><expr><name>a</name></expr>;</expr_stmt>\n</unit>";
    const std::string srcml_hash = "<unit xmlns:cpp=\"http://www.sdml.info/srcML/cpp\" hash=\"0123456789abcdef\" language=\"C\"><expr_stmt><expr><name>a</name></expr>;</expr_stmt>\n</unit>";
    const std::string srcml_hash_generated = "<unit xmlns:cpp=\"http://www.sdml.info/srcML/cpp\" hash=\"\" language=\"C\"><expr_stmt><expr><name>a</name></expr>;</expr_stmt>\n</unit>";
    ...
    */
...

    {
        ...
        srcml_unit_set_directory(unit, "test");
        srcml_unit_set_version(unit , "1");
        int fd = open("project_utf8.cpp", O_RDONLY);
        srcml_parse_unit_fd(unit, fd);
        dassert(*unit->unit, utf8_srcml);
        close(fd);
...

    {
        ...
        srcml_unit_set_directory(unit, "test");
        srcml_unit_set_version(unit , "1");
        int fd = open("project_latin.cpp", O_RDONLY);
        srcml_parse_unit_fd(unit, fd);
        dassert(*unit->unit, latin_srcml);
        close(fd);
