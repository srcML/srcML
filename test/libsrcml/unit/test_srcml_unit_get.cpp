...
int main(int, char* argv[]) {
    ...
    */
...

    {
        ...
        srcml_unit_set_language(unit, "C++");
        srcml_unit_parse_memory(unit, "a;", 2);
        dassert(srcml_unit_get_srcml_fragment(unit), std::string("<unit revision=\"1.0.0\" language=\"C++\" hash=\"a301d91aac4aa1ab4e69cbc59cde4b4fff32f2b8\"><expr_stmt><expr><name>a</name></expr>;</expr_stmt></unit>"));
        srcml_unit_free(unit);
    }
/*
    {
...
//        unit->srcml = "<unit/>";
        char * xml = 0;
//        size_t size = 0;
//        srcml_unit_get_srcml(unit, 0, &xml, &size);
